...
public class DatabaseImpl
    ...
    {
        return new File("database/databases/" + this.name + "/" + name).exists();
    }
    ...
    public Document getDocument(String name)
    {
        ...
        if(document == null)
        {
            File doc = new File("database/databases/" + this.name + "/" + name);
            if(doc.exists())
            {
    ...
    public Database delete(String name)
    {
        ...
        new File("database/databases/" + this.name + "/" + name).delete();
        return this;
    }
    ...
    public void save()
    {
        ...
        {
            document.saveAsConfig(new File("database/databases/" + this.name + "/" + document.getString(UNIQUE_NAME_KEY)));
        }
    }
